...
const EditInterests = lazy(() => import("@/components/editProfile/EditInterests"));
  ...
  return (
      <section className="w-full flex items-center justify-center bg-white dark:bg-black  backdrop-blur-lg transition-opacity duration-300 relative md:py-56 py-28 lg:py-28 ">
        ...
        <div className="w-full flex justify-center">
          ...
          <Seperator text={"Your Interests"} />
          <div className="w-full flex flex-col justify-between items-start px-2 py-4 gap-3">
            <p className="text-sm text-gray-500 dark:text-gray-400 font-ubuntu">
              These help us suggest the right courses for you on your dashboard.
            </p>
            <Suspense fallback={<div>Loading interests editor...</div>}>
              <EditInterests />
            </Suspense>
          </div>
