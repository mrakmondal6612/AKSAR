...
const DashBoard = () => {
  ...
  return (
      ...
      >
        <motion.div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 px-2">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold font-libre bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
          ...
          ,{" "}
          <TextFlipSmoothRevealEffect text={`${userData.fullName}!`} className="text-xl sm:text-2xl md:text-3xl font-libre underline" />
        </h1>
      </motion.div>
        ...
        <motion.p
          ...
          className="text-sm sm:text-base text-gray-700 dark:text-gray-400 font-libre w-full sm:w-3/4 overflow-y-hidden font-extralight line-clamp-4"
        >
          <i>
        ...
        (<div className="w-full flex flex-col justify-center items-center gap-4 p-4 sm:p-6 bg-yellow-100 border border-yellow-300 rounded-md shadow-md">
                <p className="text-base sm:text-lg font-ubuntu text-center text-yellow-800">
