...
exports.handleGenerateQuestionsWithAI = exports.handleEvaluateSAQWithAI = exports.handleGenerateTestWithAI = void 0;
const Test_model_1 = __importDefault(require("../../models/Test.model"));
const Course_model_1 = __importDefault(require("../../models/Course.model"));
const generative_ai_1 = require("@google/generative-ai");
// Initialize Gemini AI
const genAI = new generative_ai_1.GoogleGenerativeAI(process.env.GEMINI_API_KEY || "");
const handleGenerateTestWithAI = async (req, res) => {
    try {
        const { courseId, title, description, difficulty, questionCount, questionTypes, duration, passingScore, topics, courseDetails, } = req.body;
...
`;
        try {
            ...
            const questionsWithOrder = aiResponse.questions.map((q, index) => ({
                ...q,
                order: index + 1,
            }));
...
exports.handleGenerateTestWithAI = handleGenerateTestWithAI;
const handleEvaluateSAQWithAI = async (req, res) => {
    try {
...
exports.handleEvaluateSAQWithAI = handleEvaluateSAQWithAI;
const handleGenerateQuestionsWithAI = async (req, res) => {
    try {
...
exports.handleGenerateQuestionsWithAI = handleGenerateQuestionsWithAI;
