...
export const EMAIL_TEMPLATES = {
   ...
   */
  WELCOME_WITH_PASSWORD: (password: string) => `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
   ...
   */
  COURSE_ENROLLMENT: (courseName: string, courseUrl: string) => `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
   ...
   */
  CERTIFICATE_ISSUED: (courseName: string, certificateUrl: string) => `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
   ...
   */
  GENERAL_NOTIFICATION: (title: string, message: string, actionUrl?: string) => `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
