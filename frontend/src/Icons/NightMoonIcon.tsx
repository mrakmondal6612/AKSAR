...
interface NightMoonIconProps {
  fillColor: string;
  size: number; // Size in pixels
}

const NightMoonIcon: React.FC<NightMoonIconProps> = ({ fillColor, size }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        fill="none" // Fill is set to none
        stroke={fillColor} // Stroke color set to fillColor
        strokeWidth={15} // You can adjust the stroke width as needed
