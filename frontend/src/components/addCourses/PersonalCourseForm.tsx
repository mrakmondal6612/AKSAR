...
const PersonalCourseFormSchema = z
  .object({
    ...
    sellingPrice: z
      .number().nonnegative("Selling price must be a positive number"),
    originalPrice: z
      .number()
...
type PersonalCourseFormData = z.infer<typeof PersonalCourseFormSchema>;
...
const PersonalCourseForm: React.FC = () => {
  const {
    register,
    handleSubmit,
    setValue,
