...
const HeroLeftSection = () => {
  ...
  return (
    <section className="w-full mx-auto min-h-screen flex flex-col justify-center items-start px-4 sm:px-5 md:px-6 py-20 md:py-0">
      <div className="w-full flex flex-col gap-8 md:gap-10">
        <div className="w-full flex flex-col gap-2 md:gap-3 text-start items-start justify-center">
          <div className="w-full flex flex-col text-start items-start justify-center">
            <h1 className="text-black dark:text-white font-ubuntu font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl w-fit leading-tight sm:leading-[2.5rem] md:leading-[3rem]">
          ...
          <DescriptionWithLoop/>
          <div className="flex flex-col sm:flex-row sm:gap-8 gap-6 justify-between items-center w-full sm:my-0 my-4">
